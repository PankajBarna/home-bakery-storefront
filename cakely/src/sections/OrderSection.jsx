            ...
            <div className="mb-6">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <ToggleOption
                  ...
                  title="Delivery"
                  subtitle="Within 10 km from Palava Phase 2"
                />
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs leading-6 text-slate-500">
                  <span className="font-semibold">Note:</span> Please order 1 day in advance.
                </p>
                
              </div>

              {/* <div className="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-4 flex items-center">
            ...
            {cartItems.length === 0 ? (
              ...
              <div className="space-y-4">
                {cartItems.map((item) => (
                  <div
                    key={item.cartKey}
                    className="rounded-2xl border border-rose-100 p-4 bg-rose-50"
                  >
                ...
                <div className="rounded-2xl bg-slate-900 text-white p-5 mt-2">
